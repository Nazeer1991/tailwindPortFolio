      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-2xl tracking-widest  font-bold font-burtons dark:text-white">
              NAZEER
            </h1>
            <ul className="flex items-center">
              <li>
                <BsFillMoonStarsFill
                  ...
                  className="cursor-pointer txt-xl dark:text-white"
                />
              </li>
              <li>
                <a
          ...
          <div className="text-center p-10 ">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-gray-200">
              Freelancer providing services for UI/UX Developement from design.
              Join me below and let's start rolling!
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              done remote work for Skrollo{" "}
              <span className="text-teal-500">agencies</span>consulted for{" "}
              <span className="text-teal-500">Startups</span>and collaborated
              with talented people to create digital products for business and
              consumer use.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a wide range of services,including brand Programming
              and Teaching.
            </p>
          </div>
          <div className="lg:flex lg:gap-10 justify-center">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 ">
              ...
              <p className="text-gray-800 py-1 dark:text-gray-200">VS Code</p>
              <p className="text-gray-800 py-1 dark:text-gray-200">Figma</p>
              <p className="text-gray-800 py-1 dark:text-gray-200">Git</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 ">
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-grat-800">
